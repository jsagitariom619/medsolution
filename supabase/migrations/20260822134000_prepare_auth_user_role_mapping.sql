-- Preparación segura para Supabase Auth.
-- No cierra acceso anon ni altera datos clínicos.
...
revoke all on function public.crear_usuario_auth() from public, anon, authenticated;
